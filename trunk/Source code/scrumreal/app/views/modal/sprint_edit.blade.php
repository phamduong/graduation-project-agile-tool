<div id="modal-edit-sprint" class="modal modal-custom hide fade box box-color modal-with-tab" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="box-title">
      ...
      <ul class="tabs">
        ...
        <li>
          <a href="#tab-sprint-activity" data-toggle="tab">Activity</a>
        </li>
      </ul>
    </div>        
    <div class="box-content">
      <div class="tab-content row-fluid">
        ...
        <div class="tab-pane tab-activity" id="tab-sprint-activity">
          <div class="modal-body">
