...
$(document).ready(function() {
	...
	$(".userlist .img-user-info").click(function(e){
//		e.preventDefault();
//		var $el = $(this);
...
//		$("#modal-user .span2 img").attr("src", img);
	...
	$(".userlist .name").click(function(e) {
...
if($("#flot-audience").length > 0){
	var data = [[1262304000000, 100], [1264982400000, 2200], [1267401600000, 3600], [1270080000000, 5200], [1272672000000, 4500], [1275350400000, 3900], [1277942400000, 3600], [1280620800000, 4600], [1283299200000, 5300], [1285891200000, 7100], [1288569600000, 7800], [1291241700000, 7195]];
