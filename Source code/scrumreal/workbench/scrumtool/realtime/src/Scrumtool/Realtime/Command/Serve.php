...
//      $this->line('<info>ERROR</info><comment>'.$message.'</comment>');
      $this->line('<info>ERROR</info>');
    };
...
//      $this->line('<info>SUBSCRIBE</info><comment>'.$message.'</comment>');
...
//      $message = print_r($conn, true);
//      $message .= print_r($topic, true);
//      $this->line('<info>UNSUBSCRIBE</info><comment>'.$message.'</comment>');
      $this->line('<info>UNSUBSCRIBE</info>');
    };
...
//      $this->line('<info>RECEIVED DATA</info><comment>'.$message.'</comment>');
      $this->line('<info>RECEIVED DATA</info>');
    };
