...
class Comment extends Eloquent {
  ...
  public function getComment($entity_id, $entity_type, $count_from, $count) {
    $query = <<<SQL
...
SQL;
    $comments = array();
    $comments['list'] = DB::select($query, array($entity_id, $entity_type, $count_from, $count));
...
//        $comments['list'][$key]->attach = Attach::getAttach($comment->cid, ENTITY_COMMENT);
      }
