...
define('STORY_STATUS_ESTIMATED', 2);
define('STORY_STATUS_ASIGNED', 3);
define('STORY_STATUS_TO_DO', 4);
define('STORY_STATUS_IN_PROGRESS', 5);
define('STORY_STATUS_TO_TEST', 6);
define('STORY_STATUS_DONE', 7);
define('STORY_STATUS_SPRINT_COMPLETED', 8);
